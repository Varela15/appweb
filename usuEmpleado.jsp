          ...
          <div class="card">
              ...
              <div class="card-body" >
                  <table id="example1" width="100%" class="table-striped table-border table-hover">
                      <caption> Listar usuEmpleado</caption>
                          <thead>
                              <tr>  
                                  <th>Código</th>
                                  <th>Usuario</th>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-users"></i></span>
                                   <select class="form-control input-lg" name="nuevoPerfil" id="nuevoPerfl" >
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-lock"></i></span>
                                      <input class="form-control input-group-sm" type="text" placeholder="Ingrese Password" 
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-users"></i></span>
                                   <select class="form-control input-lg" name="editarPerfil" id="editarPerfl" value="" >
                                       <option value="Adminitrador">Adminitrador</option>
                                       <option value="Responsable de Lavado">Responsable de Lavado</option> 
                                       <option value="Responsable de Teñido">Responsable de Teñido</option> 
                                       <option value="Responsable de Secado">Responsable de Secado</option>
