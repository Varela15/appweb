    ...
    <div class="login-box" id="div-logion">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a class="h2"> <b>CORPORACIÓN ROJO</b></a>
            </div>
            <div class="card-body" id="FormularioLogin">
                <p class="login-box-msg h4"  id="pIniciarSesion" >Inicio de Sesión</p>
                ...
                <p class="mb-0" style="text-align: center;">
                    <a href="forgot-password.html" class="small" style="float: left;">Olvide mi Contraseña</a>
